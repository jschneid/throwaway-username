...
$(function () {
    ...
    $('#random-digits').on('change', () => {
        updateTrailingDigits();
    });
});
...
function switchUsername() {
    ...
    trailingDigits = generateTrailingDigits();

    updateUsername();
}

function updateUsername() {
    words = [adjective, noun, trailingDigits];
...
function updateTrailingDigits() {
    trailingDigits = generateTrailingDigits();
    updateUsername();

}

function generateTrailingDigits() {
    const digitCount = $('#random-digits').val();
    let digitString = '';
    for (let i = 0; i < digitCount; i++) {
        digitString += randomIntFromInterval(0, 9);
    }
    return digitString;
}
